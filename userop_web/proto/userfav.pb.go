...
func (x *UserFavExist) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserFavExist) ProtoMessage() {}

func (x *UserFavExist) ProtoReflect() protoreflect.Message {
	mi := &file_userfav_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserFavExist.ProtoReflect.Descriptor instead.
func (*UserFavExist) Descriptor() ([]byte, []int) {
	return file_userfav_proto_rawDescGZIP(), []int{3}
}

func (x *UserFavExist) GetExist() bool {
	if x != nil {
		return x.Exist
	}
	return false
...
var file_userfav_proto_rawDesc = []byte{
	...
	,
	...
	0x12, 0x32, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x46, 0x61, 0x76, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x12, 0x0f, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x46, 0x61, 0x76, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x46, 0x61, 0x76, 0x45,
	0x78, 0x69, 0x73, 0x74, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_userfav_proto_goTypes = []interface{}{
	...
	(*UserFavExist)(nil),        // 3: UserFavExist
...
var file_userfav_proto_depIdxs = []int32{
	...
	4, // 6: UserFav.AddUserFav:output_type -> google.protobuf.Empty
	4, // 7: UserFav.DeleteUserFav:output_type -> google.protobuf.Empty
	3, // 8: UserFav.GetUserFavDetail:output_type -> UserFavExist
...
type UserFavClient interface {
	...
	GetUserFavDetail(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*UserFavExist, error)
}
...
func (c *userFavClient) GetUserFavDetail(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*UserFavExist, error) {
	out := new(UserFavExist)
...
type UserFavServer interface {
	...
	GetUserFavDetail(context.Context, *UserFavRequest) (*UserFavExist, error)
}
...
func (*UnimplementedUserFavServer) GetUserFavDetail(context.Context, *UserFavRequest) (*UserFavExist, error) {
